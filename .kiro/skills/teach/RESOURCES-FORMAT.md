...
- **Record community preferences.** If the user has opted out of joining communities, note that in `.user/learner-profile.md`; `RESOURCES.md` remains shareable research curation.
