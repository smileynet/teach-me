...
part: 5
section: "Long example: crime scene"
tags: ["game-queries", "lists", "tunnels"]
---

<!-- search: Developers search for this when: full ink example, crime scene investigation, complex list usage, complete working story -->
