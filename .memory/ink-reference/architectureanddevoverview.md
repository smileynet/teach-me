---
type: ink-reference
source: "ArchitectureAndDevOverview.md"
section: "Architecture and Development"
tags: ["architecture", "compiler", "internals"]
---

<!-- search: Developers search for this when: ink compiler architecture, how ink works internally, compilation pipeline, development overview -->
