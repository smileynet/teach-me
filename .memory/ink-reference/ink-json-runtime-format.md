---
type: ink-reference
source: "ink_JSON_runtime_format.md"
section: "ink's JSON runtime format"
tags: ["json", "runtime", "format", "serialization"]
---

<!-- search: Developers search for this when: ink JSON format, compiled ink structure, runtime data format, story.json internals -->
