...
section: "Running your ink"
tags: ["runtime", "api", "csharp", "integration", "external-functions"]
---

<!-- search: Developers search for this when: runtime API, loading ink stories, saving state, variable observers, external functions, error handling, tags, C# integration, BindExternalFunction -->
